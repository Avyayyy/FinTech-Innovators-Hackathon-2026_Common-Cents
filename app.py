...
DEFAULT_ASSETS = []  # New users start with an empty portfolio
...
def wellness():
    ...
    if not assets:
        return jsonify({"diversification":0,"liquidity":0,"volatility":0,
                        "behavioural":0,"overall":0,"monthsCovered":0})
